    ...
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-6 z-50">
       ...
       <div className="relative group">
         ...
         <button
           ...
           className={`relative w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 border backdrop-blur-md ${isConnected ? 'bg-white/10 border-white/20 text-white' : 'bg-black/40 border-white/10 text-slate-500'}`}
         >
       ...
       <button
         ...
         className={`relative h-20 w-20 rounded-full flex items-center justify-center transition-all duration-500 transform active:scale-95 shadow-2xl border-4 border-transparent ${
            isConnected
              ? 'bg-rose-500 hover:bg-rose-600 text-white shadow-rose-500/30 hover:shadow-rose-500/50'
              : 'bg-white hover:bg-slate-100 text-slate-900 shadow-white/10 hover:shadow-white/20'
       ...
       <div className="relative group">
          ...
          <button
            ...
            className={`relative w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 border backdrop-blur-md ${isVideoActive ? 'bg-white text-slate-900 border-white' : 'bg-black/40 border-white/10 text-white hover:bg-white/10'}`}
          >
            {isVideoActive ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
